...
//Thanks to @samarthagarwal and his contribution to open source with such beautiful loaders.
//Find more on:
// https://github.com/samarthagarwal/FlutterScreens


class CursorLoader extends StatefulWidget {

  final Color color1;
  final Color color2;
  final Color color3;

  CursorLoader({this.color1 = Colors.deepOrangeAccent, this.color2 = Colors.yellow, this.color3 = Colors.lightGreen});

  @override
  _CursorLoaderState createState() => _CursorLoaderState();
}

class _CursorLoaderState extends State<CursorLoader> with TickerProviderStateMixin {
